...
;// CONCATENATED MODULE: ./src/components/block-slim/block-slim.styles.ts

const cssPropDefaults = {};
/* harmony default export */ const block_slim_styles = (i `
  .block-slim {
    display: flex;
...
;// CONCATENATED MODULE: ./src/components/block-slim/index.ts




let BlockSlim = class BlockSlim extends lit_element_s {
    render() {
        return x `<div class="block-slim">
      <slot name="block-slim"></slot>
    </div>`;
    }
};
BlockSlim.styles = [block_slim_styles];
BlockSlim = __decorate([
    custom_element_t('cascade-block-slim')
], BlockSlim);
