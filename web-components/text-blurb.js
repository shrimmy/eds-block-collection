...
;// CONCATENATED MODULE: ./src/components/text-blurb/text-blurb.styles.ts

/* harmony default export */ const text_blurb_styles = (i `
  .theme-night {
    background-color: var(--ds-color-black, black);
    color: var(--ds-theme-foreground-accent-subtle-selected, white);
  }
...
;// CONCATENATED MODULE: ./src/components/text-blurb/index.ts
...
let TextBlurb = class TextBlurb extends lit_element_s {
    constructor() {
        super(...arguments);
        /**
    ...
    render() {
        return x `
      <div class="tb-layout theme-${this.theme}">
        <p class="tb-text"><slot name="text"></slot></p>
      </div>
    `;
    }
};
TextBlurb.styles = [text_blurb_styles, colorUtils];
__decorate([
    property_n()
], TextBlurb.prototype, "theme", void 0);
__decorate([
    property_n({ attribute: 'no-animation', type: Boolean })
], TextBlurb.prototype, "noAnimation", void 0);
__decorate([
    query_e('.tb-text')
], TextBlurb.prototype, "text", void 0);
__decorate([
    query_e('.tb-layout')
], TextBlurb.prototype, "layout", void 0);
TextBlurb = __decorate([
    custom_element_t('cascade-text-blurb')
], TextBlurb);
