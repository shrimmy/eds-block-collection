...
__webpack_require__.d(__webpack_exports__, {
  InteractiveFeatureCamera: () => (/* binding */ InteractiveFeatureCamera)
});
...
;// CONCATENATED MODULE: ./src/components/interactive-feature-camera/interactive-feature-camera.styles.ts

const cssPropDefaultsLightTheme = {
    backgroundColor: 'linear-gradient(173.97deg, #E8F5FE 9.26%, #FFF3E1 24.78%, #D2ECFF 39.86%, #B1D9EF 64.17%, #E8F5FE 87.69%)',
    cardBackgroundGradient: '#fff',
    cardBorderColor: '#005FCF',
    cardBorderGradient: 'linear-gradient(118.71deg, #0736C3 9.27%, rgba(7, 54, 195, 0.2) 93.26%)',
    activeDotColor: '#0736C3',
    checkedSliderColor: '#0736C3',
    buttonBorderColor: '#0736C3',
    buttonBorderGradient: 'linear-gradient(to right, #0736C3, rgba(7, 54, 195, 0.2))',
    eyebrowGradientColor: 'linear-gradient(269.94deg, #835B3D 13.86%, #0A1E2C 37.22%, #0A1E2C 62.56%, #075E98 89.88%)',
};
const cssPropDefaultsDarkTheme = {
    backgroundColor: '#0A0520',
    cardBackgroundGradient: 'linear-gradient(105.36deg, #253054 0.61%, rgba(51, 48, 61, 0.5) 169.87%)',
    cardBorderColor: '#3DCBFF',
    cardBorderGradient: 'linear-gradient(101.9deg, #3DCBFF 1.99%, #EAF8FE 36.02%, #9FE5FF 66.76%, rgba(61, 203, 255, 0.85) 87.71%)',
    activeDotColor: '#3DCBFF',
    checkedSliderColor: '#3DCBFF',
    buttonBorderColor: '#3DCBFF',
    buttonBorderGradient: 'linear-gradient(to right, #3DCBFF, rgba(61, 203, 255, 0.85))',
    eyebrowGradientColor: 'linear-gradient(272.08deg, #FFB98A 7.15%, #E1DFF2 48.43%, #FFFFFF 71.63%, #E1DFF2 102.16%)',
};
const interactiveStyles = i `
  .full-screen-text {
    text-align: center;
  }
  .interactive-feature-container .feature-toggles {
    display: flex;
    position: relative;
  }
  .interactive-feature-container .asset-section {
    flex: 0 0 70%;
    position: relative;
    /* opacity: 0; */
    /* transform: translateY(20%); */
  }
  .interactive-feature-container .asset-section .asset-img img,
  .interactive-feature-container .asset-section .asset-video video {
    width: 100%;
    display: none;
    height: 100%;
  ...
  .interactive-feature-container .asset-section .asset-video video.visible,
  .interactive-feature-container .asset-section .asset-img img.visible {
    animation: assetchange 0.5s;
  }
  .interactive-feature-container .asset-section .asset-img img.visible,
  .interactive-feature-container .asset-section .asset-video video.visible {
    opacity: 1;
  ...
  :host([dir='rtl'])
    .interactive-feature-container
    .asset-section
    .asset-video
    video {
    clip-path: inset(2px 0px 2px 2px);
  }
  .interactive-feature-container .toggles-section {
    flex: 0 0 40%;
    position: absolute;
    top: 50%;
    left: 57%;
    ...
    background: var(
      --ds-ifc-card-background-gradient,
      ${r(cssPropDefaultsLightTheme.cardBackgroundGradient)}
    );
    padding: 24px;
    border: 1px solid
      var(
        --ds-ifc-card-border-color,
        ${r(cssPropDefaultsLightTheme.cardBorderColor)}
      );
    border-radius: 8px;
    transition:
      opacity 0.5s,
  ...
  :host([dir='rtl']) .interactive-feature-container .toggles-section {
    right: 57%;
    left: auto;
  }
  .interactive-feature-container .toggles-section::before {
    top: -1px;
    transform: rotate(180deg);
  }
  .interactive-feature-container .toggles-section::after {
    bottom: -1px;
  }
  .interactive-feature-container .toggles-section::before,
  .interactive-feature-container .toggles-section::after {
    ...
    right: 8px;
    background: var(
      --ds-ifc-card-border-gradient,
      ${r(cssPropDefaultsLightTheme.cardBorderGradient)}
    );
  }
  .interactive-feature-container .toggle-title-area {
    display: flex;
    align-items: center;
    gap: 24px;
    padding-bottom: 16px;
  }
  .interactive-feature-container .toggle-title-area .right-copy .title {
    margin: 0;
    padding-bottom: 8px;
    font-size: 21px;
    font-weight: 600;
  ...
  .interactive-feature-container .toggle-title-area .right-copy .paragraph {
    margin: 0;
    font-size: 16px;
    line-height: 24px;
    font-weight: 400;
  ...
  .interactive-feature-container {
    ...
    overflow: hidden;
    background: var(
      --ds-ifc-container-background-color,
      ${r(cssPropDefaultsLightTheme.backgroundColor)}
    );
  }
  .sticky-disabled {
  ...
  /* Toggle button CSS */
  .interactive-feature-container .individual-toggle {
    display: flex;
    align-items: center;
  ...
  .interactive-feature-container .individual-toggle .toggle-label {
    font-weight: 600;
    flex: 0 0 50%;
    pointer-events: none;
  }
  .interactive-feature-container .individual-toggle:last-child {
    border-bottom: 1px solid #ccc;
  }
  .interactive-feature-container .individual-toggle:nth-child(3n) {
    border-bottom: 1px solid #ccc;
  }
  .interactive-feature-container .toggle-button-area .toggle-text-before {
    padding-right: 8px;
  }
  .interactive-feature-container .toggle-button-area .toggle-text-after {
    padding-left: 8px;
  }
  .interactive-feature-container .individual-toggle .toggle-button {
    position: relative;
  ...
  .interactive-feature-container .individual-toggle .toggle-button input {
    opacity: 0;
    width: 0;
    height: 0;
  }
  ...
  input:checked + .slider {
    background-color: var(
      --ds-ifc-active-dot-color,
      ${r(cssPropDefaultsLightTheme.checkedSliderColor)}
    );
  }
  input:checked + .slider:before {
    transform: translateX(16px);
  }
  .toggle-button input:focus-visible + .slider {
    outline: 2px dashed #000;
    outline-offset: 1px;
  }
  .interactive-feature-container .toggle-area-hidden-paragraph {
    display: none;
  }
  .interactive-feature-container .toggle-title-area .right-copy .paragraph {
    display: block;
  ...
  .interactive-feature-container .toggle-controls .toggle-button,
  .interactive-feature-container
    .feature-toggles
    .asset-section
    .video-play-pause
    ...
    border: 2px solid
      var(
        --ds-ifc-button-border-color,
        ${r(cssPropDefaultsLightTheme.buttonBorderColor)}
      ) !important;
    background: #ffffff;
    background:
      linear-gradient(white, white) padding-box,
      var(
          --ds-ifc-button-border-gradient,
          ${r(cssPropDefaultsLightTheme.buttonBorderGradient)}
        )
  ...
  .interactive-feature-container .toggle-controls .toggle-button svg {
    width: 20px;
  }
  .interactive-feature-container
    .feature-toggles
  ...
  .interactive-feature-container .toggle-controls .toggle-button:focus-visible,
  .interactive-feature-container
    .feature-toggles
    .asset-section
    .video-play-pause
  ...
  .interactive-feature-container .toggle-controls .indicators {
    display: flex;
    gap: 10px;
    align-items: center;
  }
  .interactive-feature-container .toggle-controls .indicator {
    width: 32px;
    height: 2px;
    border-radius: 80px;
    background-color: #ccc;
  }
  .interactive-feature-container .toggle-controls .indicator.active {
    background-color: var(
      --ds-ifc-active-dot-color,
      ${r(cssPropDefaultsLightTheme.activeDotColor)}
    );
    height: 6px;
  }
  .interactive-feature-container .toggle-controls {
    display: flex;
    align-items: center;
    justify-content: space-between;
    padding-top: 24px;
  }
  .interactive-feature-container .individual-toggle.hidden-toggle {
    display: none;
  }
  .interactive-feature-container
    .feature-toggles
  ...
  .interactive-feature-container .title-section {
    text-align: center;
    padding-top: 60px;
  }
  .interactive-feature-container .primary-title {
    font-size: 80px;
    font-weight: 600;
    line-height: normal;
    margin-bottom: 0;
    ...
    text-align: center;
    background: var(
      --ds-ifc-eyebrow-gradient-color,
      ${r(cssPropDefaultsLightTheme.eyebrowGradientColor)}
    );
    background-clip: text;
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
  }
  .interactive-feature-container .secondary-title {
    font-size: 71px;
    font-weight: 600;
    line-height: 84px;
    margin: 0;
  ...
  .interactive-feature-container .text-behind {
    overflow: hidden;
    /* margin-top: -.4em;
  margin-bottom: .2em; */
    padding-bottom: 0.6em;
  }
  .interactive-feature-container .primary-link {
    margin: 34px 0 40px;
    display: inline-block;
  }
  .interactive-feature-container .primary-link a {
    font-size: 16px;
    background: #5440f1;
    padding: 10px 18px;
    color: #fff;
  ...
  .interactive-feature-container.ifc-animation-off .toggles-section {
    transform: translateY(-50%);
  }
  .interactive-feature-container .left-icon img {
    width: 64px;
    height: 64px;
  }

  /* Dark Theme */
  .interactive-feature-container.theme-night {
    background: var(
      --ds-ifc-container-background-color,
      ${r(cssPropDefaultsDarkTheme.backgroundColor)}
    );
  }
  .interactive-feature-container.theme-night .primary-title {
    color: #fff;
    background: var(
      --ds-ifc-eyebrow-gradient-color,
      ${r(cssPropDefaultsDarkTheme.eyebrowGradientColor)}
    );
    background-clip: text;
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
  }
  .interactive-feature-container.theme-night .secondary-title {
    color: #fff;
  }
  .interactive-feature-container.theme-night .toggles-section {
    border: 1px solid
      var(
        --ds-ifc-card-border-color,
        ${r(cssPropDefaultsDarkTheme.cardBorderColor)}
      );
    background: var(
      --ds-ifc-card-background-gradient,
      ${r(cssPropDefaultsDarkTheme.cardBackgroundGradient)}
    );
    color: #fff;
  }
  .interactive-feature-container.theme-night .toggles-section::before,
  .interactive-feature-container.theme-night .toggles-section::after {
    background: var(
      --ds-ifc-card-border-gradient,
      ${r(cssPropDefaultsDarkTheme.cardBorderGradient)}
    );
  }
  .interactive-feature-container.theme-night .toggle-button .slider {
    background-color: #fff;
  }
  .interactive-feature-container.theme-night .toggle-button .slider:before {
    background-color: #000;
  }
  .interactive-feature-container.theme-night input:checked + .slider {
    background-color: var(
      --ds-ifc-active-dot-color,
      ${r(cssPropDefaultsDarkTheme.checkedSliderColor)}
    );
  }
  .interactive-feature-container.theme-night
    .toggle-controls
    ...
    background-color: var(
      --ds-ifc-active-dot-color,
      ${r(cssPropDefaultsDarkTheme.activeDotColor)}
    );
  }
  .interactive-feature-container.theme-night .toggle-controls .toggle-button,
  .interactive-feature-container.theme-night
    .feature-toggles
    .asset-section
    .video-play-pause
    ...
    border: 2px solid
      var(
        --ds-ifc-button-border-color,
        ${r(cssPropDefaultsDarkTheme.buttonBorderColor)}
      ) !important;
    background:
      linear-gradient(#33303d, #33303d) padding-box,
      var(
          --ds-ifc-button-border-gradient,
          ${r(cssPropDefaultsDarkTheme.buttonBorderGradient)}
        )
        border-box !important;
  }
  .interactive-feature-container.theme-night
...
;// CONCATENATED MODULE: ./src/components/interactive-feature-camera/index.ts
...
let InteractiveFeatureCamera = class InteractiveFeatureCamera extends WithLocalization {
    constructor() {
        super();
        this.noAnimation = window.matchMedia(`(prefers-reduced-motion: reduce)`).matches === true;
        this._playPromise = null;
        this._noAnimation = window.matchMedia(`(prefers-reduced-motion: reduce)`).matches === true;
        this.scrollTriggers = [];
    ...
    firstUpdated() {
        this._interactiveFeatureCameras.forEach((container, index) => {
            const delay = (index + 1) * 300;
            setTimeout(() => {
                this.initializeInteractiveFeatureCamera(container);
            }, delay);
        });
    }
    assetHeightCal() {
        if (this._assetSection) {
            const videoHeight = window.getComputedStyle(this._assetVideo);
            const imgHeight = window.getComputedStyle(this._assetImg);
            if (this._assetVideo.classList.contains('visible')) {
                this._assetSection.style.minHeight =
                    videoHeight.getPropertyValue('height');
            }
            else if (this._assetImg.classList.contains('visible')) {
                this._assetSection.style.minHeight =
                    imgHeight.getPropertyValue('height');
            }
            else {
                this._assetSection.style.minHeight =
                    imgHeight.getPropertyValue('height');
    ...
    disconnectedCallback() {
        window.removeEventListener('resize', this.assetHeightCal);
        super.disconnectedCallback();
    }
    initializeInteractiveFeatureCamera(container) {
        const videos = container.querySelectorAll('.toggle-button-area input');
        const individualToggles = container.querySelectorAll('.individual-toggle');
        const toggleControls = this._toggleControls;
        const indicatorsContainer = this._indicatorsContainer;
        const labels = container.querySelectorAll('.toggle-label');
        const totalSlides = Math.ceil(individualToggles.length / 3);
        let currentSlide = 0;
        let lastCheckedCheckbox = null;
        let counter = this.globalCounter;
        this.assetHeightCal();
        if (document.body.classList.contains('animation-toggle') ||
            !document.body.classList.contains('animation-off')) {
            this.scrollAnimation(container);
            container.classList.add('ifc-animation-on');
            container.classList.remove('ifc-animation-off');
        }
        else {
            container.classList.remove('ifc-animation-on');
            container.classList.add('ifc-animation-off');
        }
        if (this._noAnimation) {
            this._assetVideo.pause();
        }
        this._assetVideo?.addEventListener('ended', () => {
            this.handleVideoEnded(this._assetVideo);
        });
        // Set default play/pause attributes
        this._playPauseButton?.setAttribute('aria-label', this._playPauseButton.getAttribute('data-pausetext') || '');
        this._playPauseButton?.setAttribute('title', this._playPauseButton?.getAttribute('data-pausetext') || '');
        if (document.body.classList.contains('animation-toggle') ||
            !document.body.classList.contains('animation-off')) {
            // Play the default video if no checkboxes are checked and the video is not already playing
            this.playDefaultVideo();
        }
        else {
            this.updatePlayPauseDisplay();
            if (this._defaultVideo?.getAttribute('data-defaultvideo') === '') {
                const imgSrc = this._defaultVideo?.getAttribute('data-defaultposter') || '';
                const imgAlt = this._defaultVideo.getAttribute('data-defaultdescription') || '';
                this._assetImg.src = imgSrc;
                this._assetImg.alt = imgAlt;
                this._assetImg.classList.add('visible');
                this._assetVideo.classList.remove('visible');
                this._playPauseButton.style.display = 'none';
            }
        }
        const pauseVideo = (vdo) => {
            if (vdo && !vdo.paused) {
                vdo.pause();
            }
        };
        const checkAnimationToggle = () => {
            if (document.body.classList.contains('animation-toggle')) {
                this._playPromise = this._assetVideo.play();
            }
            else {
                this._assetVideo.load();
                this._assetVideo.autoplay = false;
                this._assetVideo.pause();
            }
            this._assetVideo.classList.add('visible');
            this._assetImg.classList.remove('visible');
            this._playPauseButton.style.display = 'block';
        ...
        const assetChange = () => {
            this._checkboxes.forEach((checkbox, index) => {
                // Setting unique ID's for label & input checkbox
                const uniqueId = 'switch-' + counter++;
                ...
                checkbox.addEventListener('change', (event) => {
                    ...
                    if (event.target.checked) {
                        if (lastCheckedCheckbox &&
                            ...
                            lastCheckedCheckbox.checked = false; // Uncheck the previous checkbox
                        }
                        if (video) {
                            // Check if there is a valid data-video attribute
                            const videoSrc = event.target.getAttribute('data-video');
                            if (videoSrc) {
                                if (videoSrc !== decodeURI(this._assetVideoSource.src)) {
                                    this._assetVideoSource.src = videoSrc;
                                    this._assetVideo.poster =
                                        event.target.getAttribute('data-img') || '';
                                    this._assetVideo.ariaLabel =
                                ...
                                if (this._playPromise !== undefined) {
                                    this._playPromise
                                        ?.then((_) => {
                                        pauseVideo(this._assetVideo);
                                        if (this._assetVideo.paused) {
                                            this._assetVideo.load();
                                        }
                                        checkAnimationToggle();
                                    })
                                        .catch((error) => {
                                        checkAnimationToggle();
                                ...
                                // If no data-video, show the image
                                const imgSrc = event.target.getAttribute('data-img') || '';
                                const imgAlt = event.target.getAttribute('data-description') || '';
                                this._assetImg.src = imgSrc;
                                this._assetImg.alt = imgAlt;
                                this._assetImg.classList.add('visible');
                                this._assetVideo.classList.remove('visible');
                        ...
                        lastCheckedCheckbox = event.target; // Update the last checked checkbox
                    }
                    else {
                        // Check if no checkboxes are checked, set default video attributes
                        const noCheckboxChecked = !Array.from(this._checkboxes).some((checkbox) => checkbox.getAttribute('checked'));
                        if (noCheckboxChecked) {
                            if (this._defaultVideo.getAttribute('data-defaultvideo') !== '') {
                                this._assetVideoSource.src =
                                    this._defaultVideo.getAttribute('data-defaultvideo') ||
                                        '';
                                this._assetVideo.poster =
                                    this._defaultVideo.getAttribute('data-defaultposter') ||
                                        '';
                                this._assetVideo.ariaLabel =
                                    this._defaultVideo.getAttribute('data-defaultdescription');
                                this.updatePlayPauseDisplay();
                                this._playPromise === null && this._assetVideo.load();
                                if (this._playPromise !== undefined) {
                                    this._playPromise
                                        ?.then((_) => {
                                        pauseVideo(this._assetVideo);
                                ...
                                this._playPauseButton.setAttribute('aria-label', this._playPauseButton.getAttribute('data-playtext') || '');
                                this._playPauseButton.setAttribute('title', this._playPauseButton.getAttribute('data-playtext') || '');
                            }
                            else {
                                // If no data-video, show the image
                                this._assetImg.classList.add('visible');
        ...
        assetChange();
        // Show/hide toggle-controls based on the number of individual-toggle elements
        function updateCarousel(el) {
            if (individualToggles.length <= 3) {
            ...
            for (let i = currentSlide * 3; i < (currentSlide + 1) * 3 && i < individualToggles.length; i++) {
                individualToggles[i].classList.remove('hidden-toggle');
            }
        }
        function updateIndicators(indicatorsContainer) {
        ...
        updateCarousel(this._toggleControls);
        updateIndicators(this._indicatorsContainer);
        // Event listener for the right-button click
        container
            ?.querySelector('.right-button')
            ?.addEventListener('click', function () {
            if (currentSlide < Math.ceil(individualToggles.length / 3) - 1) {
                currentSlide++;
                updateCarousel(toggleControls);
                updateIndicators(indicatorsContainer);
            }
        });
        ...
        const updatePlayPauseButton = () => {
            if (this._assetVideo.paused) {
                if (this._assetVideo.currentTime == this._assetVideo.duration) {
                    this._assetVideo.currentTime = 0;
                }
                this._assetVideo.play();
            }
            else {
                this._assetVideo.pause();
            }
        ...
        // Add event listeners to update the play/pause button based on video state
        this._assetVideo?.addEventListener('play', () => {
            this.updatePlayPauseButtonState();
            this.updatePlayPauseDisplay();
        });
        this._assetVideo?.addEventListener('pause', () => {
            this.updatePlayPauseButtonState();
            this.updatePlayPauseDisplay();
        });
        ...
        checkbox?.addEventListener('click', () => {
            setTimeout(() => {
                ...
                if (bodyElement.classList.contains('animation-toggle')) {
                    container.classList.remove('ifc-animation-off');
                    container.classList.add('ifc-animation-on');
                    this.scrollAnimation(container);
                    assetChange();
                    if (this._assetVideo.src !== '') {
                        this._playPromise = this._assetVideo.play();
                    }
                    this._animationSpacer.style.display = 'block';
                }
                else {
                    container.classList.remove('ifc-animation-on');
                    container.classList.add('ifc-animation-off');
                    ...
                    this._playPauseButton.setAttribute('aria-label', this._playPauseButton.getAttribute('data-playtext') || '');
                    this._playPauseButton.setAttribute('title', this._playPauseButton.getAttribute('data-playtext') || '');
                    this._animationSpacer.style.display = 'none';
    ...
    playDefaultVideo() {
        if (this._assetVideo != null &&
            this._assetVideo.paused &&
            !this._assetVideo.classList.contains('played')) {
            this._assetVideoSource.src =
                this._defaultVideo?.getAttribute('data-defaultvideo') || '';
            this._assetVideo.poster =
                this._defaultVideo?.getAttribute('data-defaultposter') || '';
            this._assetVideo.ariaLabel = this._defaultVideo.getAttribute('data-defaultdescription');
            if (this._defaultVideo?.getAttribute('data-defaultvideo') !== '') {
                if (this._playPromise !== undefined) {
                    this._playPromise
                        ?.then((_) => {
                ...
                this._assetVideo.loop = false;
                this._playPromise = this._assetVideo.play();
                // Add 'played' class to mark that the video has been played
                this._assetVideo.classList.add('played');
    ...
    // Function to update the display of play/pause icons
    updatePlayPauseDisplay() {
        this._playIcon.style.display = this._assetVideo.paused
            ? 'inline-block'
            : 'none';
        this._pauseIcon.style.display = this._assetVideo.paused
            ? 'none'
            : 'inline-block';
    }
    // Function to update the state of the play/pause button
    ...
    scrollAnimation(container) {
        ...
        const primaryTitle = container.querySelector('.primary-title');
        const secondaryTitle = container.querySelector('.secondary-title');
        const assetSection = container.querySelector('.asset-section');
        const toggleSection = container.querySelector('.toggles-section');
        const primaryLink = container.querySelector('.primary-link');
        const ifcAnimation = this.gsap.timeline({
            scrollTrigger: {
                trigger: container,
                start: 'top',
                end: 'center',
        ...
        ifcAnimation.fromTo(primaryTitle, {
            opacity: 1,
            fontSize: () => this.fitText(primaryTitle, '0.3', {
            ...
            stagger: 0.05,
            fontSize: () => (window.innerWidth <= 1084 ? '40px' : '80px'),
            lineHeight: () => (window.innerWidth <= 1084 ? '48px' : '120px'),
            duration: 0.5,
            scale: 1,
            translateY: '0',
            position: 'relative',
            paddingTop: () => (window.innerWidth <= 1084 ? '30px' : '0px'),
        }, 1);
        ifcAnimation.to(container, { duration: 0.5, ease: 'none' }, '+=1');
        ifcAnimation.fromTo(assetSection, { translateY: '30%', opacity: 0 }, { translateY: '0%', ease: 'power1.out', duration: 0.5, opacity: 1 }, 1.5);
        ifcAnimation.fromTo(toggleSection, {
            translateY: () => (window.innerWidth < 1084 ? '20%' : '-20%'),
            opacity: 0,
        }, {
            translateY: () => (window.innerWidth <= 1084 ? '0%' : '-50%'),
            ease: 'power1.out',
            duration: 0.5,
            opacity: 1,
        }, 2);
        ifcAnimation.fromTo(secondaryTitle, { translateY: '120%' }, { translateY: '0%', ease: 'power1.out', duration: 0.5 }, '1.2');
        if (primaryLink != null) {
            ifcAnimation.fromTo(primaryLink, { opacity: 0, translateY: '120%' }, { opacity: 1, translateY: '0%', ease: 'power1.out' }, 1.3);
        }
        if (ifcAnimation.scrollTrigger) {
            this.scrollTriggers.push(ifcAnimation.scrollTrigger);
        }
    }
    fitText(el, kompressor, options) {
        ...
        const fit = function (el) {
            const compressor = parseInt(kompressor) || 1;
            const resizer = function () {
                const size = Math.max(Math.min(el.clientWidth / (compressor * 10), settings.maxFontSize), settings.minFontSize);
                el.style.fontSize = size + 'px';
                el.style.lineHeight =
                    size * settings.lineHeightMultiplier +
                        settings.lineHeightOffset * 2 +
                        'px';
            };
            // Call once to set.
            resizer();
    ...
    killScrollTriggerAnimation() {
        /* Turns off scroll animation in reduced motion*/
        let targets = [];
    ...
    handleVideoEnded(assetVideo) {
        assetVideo.classList.add('played');
        if (assetVideo.currentTime != assetVideo.duration) {
            assetVideo.pause();
            assetVideo.currentTime = assetVideo.duration;
        }
    }
    renderToggles() {
        return static_n `
      ${this.featuresContent.keyFeatures?.map((feature) => static_n `<div class="individual-toggle">
            <label class="toggle-label" for="">${feature.toggleTitle}</label>
            <div class="toggle-button-area">
              <span class="toggle-text-before">${this.msg('OFF')}</span>
              <label class="toggle-button">
                <input
                  type="checkbox"
                  role="switch"
                  id=""
                  data-video="${feature.video.videoPath}"
                  data-img="${feature.video.posterImagePath}"
                  data-description="${feature.video.description}"
                />
                <span class="slider"></span>
              </label>
              <span class="toggle-text-after">${this.msg('ON')}</span>
            </div>
          </div>`)}
    `;
    }
    ...
    renderToggleControls() {
      ...
      <div class="toggle-controls">
        <button class="toggle-button left-button" aria-label="left button">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2048 2048">
            <path
              d="M576 1024q0-26 19-45l704-704q19-19 45-19t45 19 19 45q0 26-19 45l-658 659 658 659q19 19 19 45t-19 45-45 19q-26 0-45-19l-704-704q-19-19-19-45z"
            ></path>
          </svg>
        </button>
        <div class="indicators"></div>
        <button class="toggle-button right-button" aria-label="right button">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2048 2048">
            <path
              d="M640 1728q0-26 19-45l658-659-658-659q-19-19-19-45t19-45 45-19q26 0 45 19l704 704q19 19 19 45t-19 45l-704 704q-19 19-45 19t-45-19-19-45z"
            ></path>
          </svg>
        </button>
      </div>
    ...
    renderFeatureVideo(featureVideo) {
        ...
        return static_n `
      <video
        aria-label="${featureVideo.ariaLabel}"
        poster="${featureVideo.posterImagePath}"
        preload="auto"
        muted
        ...
        class="visible"
        data-defaultvideo="${featureVideo.videoPath}"
        data-defaultposter="${featureVideo.posterImagePath}"
        data-defaultdescription="${featureVideo.description}"
      >
        <source src="${featureVideo.videoPath}" />
      </video>
    `;
    }
    renderHeading(heading, className) {
        if (heading.headingText === '') {
            return T;
        }
        return static_n `
            <${static_i(heading.headingSize)} role='heading' class="${className} ${heading.displaySize}">
                ${unsafe_html_o(heading.headingText)}
            </${static_i(heading.headingSize)}>
        `;
    }
    render() {
        return static_n `
      <div
        class="interactive-feature-container ${this.featuresContent.theme ===
            'theme-dark'
            ? 'theme-night'
            : ''}"
      >
            ...
            <div class="toggles-section">
              <div class="toggle-title-area">
                <span class="left-icon">
                  ${this.featuresContent.iconImage
            ? static_n ` <slot name="icon-image"></slot> `
            : static_n `
                        <svg
                          width="64"
                          height="64"
                        ...
                        >
                          <path
                            d="M5.25 4C4.55964 4 4 4.55964 4 5.25V8C4 8.55228 3.55228 9 3 9C2.44772 9 2 8.55228 2 8V5.25C2 3.45507 3.45507 2 5.25 2H8C8.55228 2 9 2.44772 9 3C9 3.55228 8.55228 4 8 4H5.25ZM5.25 20C4.55964 20 4 19.4404 4 18.75V16C4 15.4477 3.55228 15 3 15C2.44772 15 2 15.4477 2 16V18.75C2 20.5449 3.45507 22 5.25 22H8C8.55228 22 9 21.5523 9 21C9 20.4477 8.55228 20 8 20H5.25ZM20 5.25C20 4.55964 19.4404 4 18.75 4H16C15.4477 4 15 3.55228 15 3C15 2.44772 15.4477 2 16 2H18.75C20.5449 2 22 3.45507 22 5.25V8C22 8.55228 21.5523 9 21 9C20.4477 9 20 8.55228 20 8V5.25ZM18.75 20C19.4404 20 20 19.4404 20 18.75V16C20 15.4477 20.4477 15 21 15C21.5523 15 22 15.4477 22 16V18.75C22 20.5449 20.5449 22 18.75 22H16C15.4477 22 15 21.5523 15 21C15 20.4477 15.4477 20 16 20H18.75ZM12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13ZM10.8484 7C10.3749 7 9.94207 7.26264 9.73033 7.67842L9.24249 9H8.66667C7.74619 9 7 9.59626 7 10.5V14.3636C7 15.2674 7.74619 16 8.66667 16H15.3333C16.2538 16 17 15.2674 17 14.3636V10.5C17 9.59626 16.2538 9 15.3333 9H14.7575L14.2697 7.67842C14.0579 7.26264 13.6251 7 13.1516 7H10.8484ZM12 14C10.8954 14 10 13.1046 10 12C10 10.8954 10.8954 10 12 10C13.1046 10 14 10.8954 14 12C14 13.1046 13.1046 14 12 14Z"
                          />
                        </svg>
                      `}
                </span>
                <span class="right-copy">
                  <slot name="toggle-area-heading"></slot>
                  <slot name="toggle-area-desciption"></slot>
                </span>
              </div>
              <div class="toggle-area-hidden-paragraph">
                <p>
                  <slot name="toggle-area-hidden-desciption"></slot>
                </p>
              </div>

              <div class="toggle-area">${this.renderToggles()}</div>
        ...
        <div
          ...
          aria-hidden="true"
          class="animation-spacer"
        ></div>
      </div>
    `;
    }
};
InteractiveFeatureCamera.styles = interactiveStyles;
InteractiveFeatureCamera.dict = {
    Play: 'Play',
    Pause: 'Pause',
    ON: 'On',
    OFF: 'Off',
...
], InteractiveFeatureCamera.prototype, "featuresContent", void 0);
__decorate([
    property_n({ attribute: 'no-animation', type: Boolean })
], InteractiveFeatureCamera.prototype, "noAnimation", void 0);
__decorate([
    query_e('.interactive-feature-container .asset-video video')
], InteractiveFeatureCamera.prototype, "_assetVideo", void 0);
__decorate([
    query_e('.interactive-feature-container .asset-video video source')
], InteractiveFeatureCamera.prototype, "_assetVideoSource", void 0);
__decorate([
    query_e('.interactive-feature-container .asset-video video')
], InteractiveFeatureCamera.prototype, "_defaultVideo", void 0);
__decorate([
    query_all_r('.interactive-feature-container .toggle-button input[type="checkbox"]')
], InteractiveFeatureCamera.prototype, "_checkboxes", void 0);
__decorate([
    query_all_r('.interactive-feature-container')
], InteractiveFeatureCamera.prototype, "_interactiveFeatureCameras", void 0);
__decorate([
    query_e('.interactive-feature-container .play-pause-button')
], InteractiveFeatureCamera.prototype, "_playPauseButton", void 0);
__decorate([
    query_e('.interactive-feature-container .asset-img img')
], InteractiveFeatureCamera.prototype, "_assetImg", void 0);
__decorate([
    query_e('.interactive-feature-container .animation-spacer')
], InteractiveFeatureCamera.prototype, "_animationSpacer", void 0);
__decorate([
    query_e('.interactive-feature-container .play-icon')
], InteractiveFeatureCamera.prototype, "_playIcon", void 0);
__decorate([
    query_e('.interactive-feature-container .pause-icon')
], InteractiveFeatureCamera.prototype, "_pauseIcon", void 0);
__decorate([
    query_e('.interactive-feature-container .indicators')
], InteractiveFeatureCamera.prototype, "_indicatorsContainer", void 0);
__decorate([
    query_e('.interactive-feature-container .toggle-controls')
], InteractiveFeatureCamera.prototype, "_toggleControls", void 0);
__decorate([
    query_e('.interactive-feature-container .asset-section')
], InteractiveFeatureCamera.prototype, "_assetSection", void 0);
InteractiveFeatureCamera = __decorate([
    defineCustomElement('cascade-interactive-feature-camera')
], InteractiveFeatureCamera);
