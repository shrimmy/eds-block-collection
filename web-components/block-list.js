...
;// CONCATENATED MODULE: ./src/styles/shared/padding.ts

const paddingUtils = i `
  .py-m {
    padding-bottom: var(--root-spacing-m, 0.25rem);
    padding-top: var(--root-spacing-m, 0.25rem);
  }
`;

;// CONCATENATED MODULE: ./src/components/block-list/block-list.styles.ts

const cssPropDefaults = {
    borderNeutralFade: '#bdc5d2',
    foregroundBaseStrong: '#0e1726',
    foregroundBaseHighlight: '#0078d4',
};
/* harmony default export */ const block_list_styles = (i `
  .list-item__inner {
    column-gap: var(--root-spacing-s, 0.75rem);
  }

  .list-item--divider-top {
    border-top: 1px solid
      var(--ds-theme-border-neutral-fade, cssPropDefaults.borderNeutralFade);
  }
  ...
  .list-item__content {
    row-gap: var(--root-spacing-2xs, 0.25re);
  }
  ...
  .fg--base-highlight {
    --fg-val: var(
      ...
      cssPropDefaults.foregroundBaseHighlight
    );
  }
  ...
  .block-feature__date {
    ...
    font-size: var(--root-label-small-font-size, 0.75rem);
    line-height: 0rem;
    margin-bottom: 0px;
  }
  ...
  .fg--base-strong {
    --fg-val: var(
      --ds-theme-foreground-base-strong,
      cssPropDefaults.foregroundBaseStrong
    );
  }
  ...
  .ai-chat-drawer__body__content__messages {
    ...
    font-size: var(--root-small-font-size, 0.875rem);
    line-height: 0rem;
  ...
  .sku__note,
  .sku__footnote,
  .ai-chat-banner .block-feature__paragraph,
  .ai-chat-drawer__disclaimer {
    font-weight: var(--root-x-small-font-weight, 400);
    font-size: var(--root-x-small-font-size, 0.75rem);
    line-height: 0rem;
    letter-spacing: var(--root-x-small-letter-spacing, -0.03em);
    margin-bottom: 0px;
  }

  .ocr-icon--size-m {
    --icon-font-size: var(--root-icon-m-font-size, 1.25rem);
    --icon-max-width: var(--root-icon-m-max-width, 20px);
    --icon-max-height: var(--root-icon-m-max-height, 20px);
  }
...
;// CONCATENATED MODULE: ./src/components/block-list/index.ts





let BlockList = class BlockList extends lit_element_s {
    constructor() {
        super(...arguments);
        this.altText = '';
        ...
        this.hideImageBadge = false;
    }
    renderContent() {
        return x `<div class="list-item__content flex-grow-1 d-flex flex-column">
      <div class="fg--base-highlight label-small">
        <slot name="label"></slot>
      </div>
      <div class="fg--base-strong small">
        <slot name="title"></slot>
      </div>
      <div class="fg--base-subtle x-small">
        <slot name="subText"></slot>
      </div>
    </div>`;
    }
    renderImage() {
        return x `<div class="list-item__leading">
        <slot name="leadingElement"><slot>
      </div>`;
    }
    renderTrailingElement() {
        return x `<div class="list-item__trailing">
        <slot name="trailingElement"><slot>
    </div>`;
    }
    render() {
        const content = this.renderContent();
        const imageContent = this.renderImage();
        const footer = this.renderTrailingElement();
        return x `<div
      class="list-item ${this.hideTopDivider
            ? ''
            : 'list-item--divider-top'} ${this.hideBottomDivider
            ? ''
            : 'list-item--divider-bottom'}"
    >
      <div class="list-item__inner d-flex align-items-center py-m">
        ${this.hideImageBadge ? T : imageContent} ${content}
        ${this.hideAction ? T : footer}
      </div>
    </div> `;
    }
};
BlockList.styles = [block_list_styles, paddingUtils];
__decorate([
    property_n()
], BlockList.prototype, "altText", void 0);
__decorate([
    property_n({ type: Boolean })
], BlockList.prototype, "hideAction", void 0);
__decorate([
    property_n({ type: Boolean })
], BlockList.prototype, "hideTopDivider", void 0);
__decorate([
    property_n({ type: Boolean })
], BlockList.prototype, "hideBottomDivider", void 0);
__decorate([
    property_n({ type: Boolean })
], BlockList.prototype, "hideImageBadge", void 0);
BlockList = __decorate([
    custom_element_t('cascade-block-list')
], BlockList);
