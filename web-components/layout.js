 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: lt, defineProperty: at, getOwnPropertyDescriptor: ct, getOwnPropertyNames: dt, getOwnPropertySymbols: pt, getPrototypeOf: $t } = Object, registration_Ac3YpkNH_f = globalThis, V = registration_Ac3YpkNH_f.trustedTypes, ut = V ? V.emptyScript : "", M = registration_Ac3YpkNH_f.reactiveElementPolyfillSupport, registration_Ac3YpkNH_b = (n, t) => n, I = { toAttribute(n, t) {
  switch (t) {
    case Boolean:
      n = n ? ut : null;
      break;
...
g.elementStyles = [], g.shadowRootOptions = { mode: "open" }, g[registration_Ac3YpkNH_b("elementProperties")] = /* @__PURE__ */ new Map(), g[registration_Ac3YpkNH_b("finalized")] = /* @__PURE__ */ new Map(), M == null || M({ ReactiveElement: g }), (registration_Ac3YpkNH_f.reactiveElementVersions ?? (registration_Ac3YpkNH_f.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w = globalThis, N = w.trustedTypes, J = N ? N.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, et = "$lit$", _ = `lit$${(Math.random() + "").slice(9)}$`, st = "?" + _, _t = `<${st}>`, registration_Ac3YpkNH_y = document, C = () => registration_Ac3YpkNH_y.createComment(""), P = (n) => n === null || typeof n != "object" && typeof n != "function", it = Array.isArray, ft = (n) => it(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", k = `[ 	
\f\r]`, registration_Ac3YpkNH_S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, K = /-->/g, Z = />/g, A = RegExp(`>|${k}(?:([^\\s"'>=/]+)(${k}*=${k}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), F = /'/g, G = /"/g, nt = /^(?:script|style|textarea|title)$/i, At = (n) => (t, ...e) => ({ _$litType$: n, strings: t, values: e }), Pt = At(1), v = Symbol.for("lit-noChange"), registration_Ac3YpkNH_d = Symbol.for("lit-nothing"), Q = /* @__PURE__ */ new WeakMap(), m = registration_Ac3YpkNH_y.createTreeWalker(registration_Ac3YpkNH_y, 129);
function rt(n, t) {
...
const mt = (n, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    for (; $ < h.length && (r.lastIndex = $, p = r.exec(h), p !== null); )
      $ = r.lastIndex, r === registration_Ac3YpkNH_S ? p[1] === "!--" ? r = K : p[1] !== void 0 ? r = Z : p[2] !== void 0 ? (nt.test(p[2]) && (i = RegExp("</" + p[2], "g")), r = A) : p[3] !== void 0 && (r = A) : r === A ? p[0] === ">" ? (r = i ?? registration_Ac3YpkNH_S, l = -1) : p[1] === void 0 ? l = -2 : (l = r.lastIndex - p[2].length, c = p[1], r = p[3] === void 0 ? A : p[3] === '"' ? G : F) : r === G || r === F ? r = A : r === K || r === Z ? r = registration_Ac3YpkNH_S : (r = A, i = void 0);
    const u = r === A && n[a + 1].startsWith("/>") ? " " : "";
    o += r === registration_Ac3YpkNH_S ? h + _t : l >= 0 ? (s.push(c), h.slice(0, l) + et + h.slice(l) + _ + u) : h + _ + (l === -2 ? a : u);
  }
...
class yt {
  ...
  u(t) {
    ...
    return m.currentNode = registration_Ac3YpkNH_y, i;
  }
  p(t) {
    let e = 0;
...
class x {
  ...
  _$AI(t, e = this) {
    t = E(this, t, e), P(t) ? t === registration_Ac3YpkNH_d || t == null || t === "" ? (this._$AH !== registration_Ac3YpkNH_d && this._$AR(), this._$AH = registration_Ac3YpkNH_d) : t !== this._$AH && t !== v && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ft(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  _(t) {
    this._$AH !== registration_Ac3YpkNH_d && P(this._$AH) ? this._$AA.nextSibling.data = t : this.T(registration_Ac3YpkNH_y.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var o;
  ...
  _$AI(t, e = this, s, i) {
    ...
    if (o === void 0)
      ...
      for (t = o[0], h = 0; h < o.length - 1; h++)
        c = E(this, a[s + h], e, h), c === v && (c = this._$AH[h]), r || (r = !P(c) || c !== this._$AH[h]), c === registration_Ac3YpkNH_d ? t = registration_Ac3YpkNH_d : t !== registration_Ac3YpkNH_d && (t += (c ?? "") + o[h + 1]), this._$AH[h] = c;
    }
    r && !i && this.j(t);
  }
  j(t) {
...
class Et extends O {
  ...
  _$AI(t, e = this) {
    if ((t = E(this, t, e, 0) ?? registration_Ac3YpkNH_d) === v)
      return;
...
;// CONCATENATED MODULE: ./node_modules/@ms-mwf/moray-web-components/dist/es/components/grid/grid/index.js
...
const grid_s = {
  ...
  columnSpanLg: "1",
  columnSpanXl: "1",
  paddingInlineStartLg: "5%",
  paddingInlineEndLg: "5%",
  widthLg: "90%",
  maxWidthXl: "1600px"
}, grid_S = Ct`
  :host {
    ...
    margin-inline-start: var(
      --ds-grid-margin-inline-start,
      ${ot(grid_s.marginInlineStart)}
    );
    margin-inline-end: var(
      --ds-grid-margin-inline-end,
      ${ot(grid_s.marginInlineEnd)}
    );
    width: var(--ds-grid-width, ${ot(grid_s.width)});
  }

  .base {
    display: grid;
    grid-template-rows: repeat(var(--ds-grid-rows, ${ot(grid_s.rows)}), 1fr);
    grid-template-columns: repeat(
      var(--ds-grid-columns, ${ot(grid_s.columns)}),
      1fr
    );
    row-gap: var(--ds-grid-row-gap, var(--ds-spacing-4, ${ot(grid_s.rowGap)}));
    column-gap: var(
      --ds-grid-column-gap,
      var(--ds-spacing-4, ${ot(grid_s.columnGap)})
    );
    padding-inline-start: var(
      --ds-grid-padding-inline-start,
      var(--ds-spacing-g, ${ot(grid_s.paddingInlineStart)})
    );
    padding-inline-end: var(
      --ds-grid-padding-inline-end,
      var(--ds-spacing-g, ${ot(grid_s.paddingInlineEnd)})
    );
  }

  ::slotted([column-span]) {
    grid-column: auto / span var(--ds-grid-column-span, ${ot(grid_s.columnSpan)});
  }

  :host([row-cols]) .base {
    grid-template-columns: repeat(var(--ds-grid-row-columns), 1fr);
  }

  /* VP2 - Small */
  @media (min-width: 540px) {
    ::slotted([column-span-sm]) {
      grid-column: auto / span
        var(--ds-grid-column-span-sm, ${ot(grid_s.columnSpanSm)});
    }

    ::slotted([column-start-sm]) {
      grid-column-start: var(--ds-grid-column-start-sm);
    }

    :host([row-cols-sm]) .base {
      grid-template-columns: repeat(var(--ds-grid-row-columns-sm), 1fr);
    }
  }

  /* VP3 - Medium */
  @media (min-width: 860px) {
    ::slotted([column-span-md]) {
      grid-column: auto / span
        var(--ds-grid-column-span-md, ${ot(grid_s.columnSpanMd)});
    }

    ::slotted([column-start-md]) {
      grid-column-start: var(--ds-grid-column-start-md);
    }

    :host([row-cols-md]) .base {
      grid-template-columns: repeat(var(--ds-grid-row-columns-md), 1fr);
    }
  }
  ...
  @media (min-width: 1084px) {
    :host {
      width: var(--ds-grid-width-lg, ${ot(grid_s.widthLg)});
    }

    .base {
      padding-inline-start: var(
        --ds-grid-padding-inline-start-lg,
        ${ot(grid_s.paddingInlineStartLg)}
      );
      padding-inline-end: var(
        --ds-grid-padding-inline-end-lg,
        ${ot(grid_s.paddingInlineEndLg)}
      );
    }

    ::slotted([column-span-lg]) {
      grid-column: auto / span
        var(--ds-grid-column-span-lg, ${ot(grid_s.columnSpanLg)});
    }

    ::slotted([column-start-lg]) {
      grid-column-start: var(--ds-grid-column-start-lg);
    }

    :host([row-cols-lg]) .base {
      grid-template-columns: repeat(var(--ds-grid-row-columns-lg), 1fr);
    }
  }
  ...
  @media (min-width: 1400px) {
    :host {
      max-width: var(--ds-grid-max-width-xl, ${ot(grid_s.maxWidthXl)});
    }

    ::slotted([column-span-xl]) {
      grid-column: auto / span
        var(--ds-grid-column-span-xl, ${ot(grid_s.columnSpanXl)});
    }

    ::slotted([column-start-xl]) {
      grid-column-start: var(--ds-grid-column-start-xl);
    }

    :host([row-cols-xl]) .base {
      grid-template-columns: repeat(var(--ds-grid-row-columns-xl), 1fr);
    }
  }

  ::slotted([column-start]) {
    grid-column-start: var(--ds-grid-column-start);
  }
`;
var grid_x = Object.defineProperty, grid_f = Object.getOwnPropertyDescriptor, grid_l = (g, a, i, d) => {
  for (var n = d > 1 ? void 0 : d ? grid_f(a, i) : a, e = g.length - 1, m; e >= 0; e--)
    (m = g[e]) && (n = (d ? m(a, i, n) : m(n)) || n);
  return d && n && grid_x(a, i, n), n;
};
const grid_y = "moray-grid";
let grid_t = class extends R {
  constructor() {
    super(...arguments), this.rowCols = null, this.rowColsSm = null, this.rowColsMd = null, this.rowColsLg = null, this.rowColsXl = null;
  }
  willUpdate() {
    this.style.setProperty("--ds-grid-row-columns", this.rowCols), this.style.setProperty("--ds-grid-row-columns-sm", this.rowColsSm), this.style.setProperty("--ds-grid-row-columns-md", this.rowColsMd), this.style.setProperty("--ds-grid-row-columns-lg", this.rowColsLg), this.style.setProperty("--ds-grid-row-columns-xl", this.rowColsXl);
  }
  render() {
    return Pt`
...
grid_t.styles = grid_S;
grid_l([
  property_CfNGmgjg_f({ attribute: "row-cols", reflect: !0 })
], grid_t.prototype, "rowCols", 2);
grid_l([
  property_CfNGmgjg_f({ attribute: "row-cols-sm", reflect: !0 })
], grid_t.prototype, "rowColsSm", 2);
grid_l([
  property_CfNGmgjg_f({ attribute: "row-cols-md", reflect: !0 })
], grid_t.prototype, "rowColsMd", 2);
grid_l([
  property_CfNGmgjg_f({ attribute: "row-cols-lg", reflect: !0 })
], grid_t.prototype, "rowColsLg", 2);
grid_l([
  property_CfNGmgjg_f({ attribute: "row-cols-xl", reflect: !0 })
], grid_t.prototype, "rowColsXl", 2);
grid_t = grid_l([
  Ut(grid_y)
], grid_t);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const lit_html_t=globalThis,lit_html_i=lit_html_t.trustedTypes,lit_html_s=lit_html_i?lit_html_i.createPolicy("lit-html",{createHTML:t=>t}):void 0,lit_html_e="$lit$",lit_html_h=`lit$${(Math.random()+"").slice(9)}$`,lit_html_o="?"+lit_html_h,lit_html_n=`<${lit_html_o}>`,lit_html_r=document,lit_html_l=()=>lit_html_r.createComment(""),lit_html_c=t=>null===t||"object"!=typeof t&&"function"!=typeof t,lit_html_a=Array.isArray,lit_html_u=t=>lit_html_a(t)||"function"==typeof t?.[Symbol.iterator],lit_html_d="[ \t\n\f\r]",lit_html_f=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,lit_html_v=/-->/g,lit_html_=/>/g,lit_html_m=RegExp(`>|${lit_html_d}(?:([^\\s"'>=/]+)(${lit_html_d}*=${lit_html_d}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),lit_html_p=/'/g,lit_html_g=/"/g,$=/^(?:script|style|textarea|title)$/i,lit_html_y=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),lit_html_x=lit_html_y(1),lit_html_b=lit_html_y(2),lit_html_w=Symbol.for("lit-noChange"),lit_html_T=Symbol.for("lit-nothing"),lit_html_A=new WeakMap,lit_html_E=lit_html_r.createTreeWalker(lit_html_r,129);function lit_html_C(t,i){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==lit_html_s?lit_html_s.createHTML(i):i}const lit_html_P=(t,i)=>{const s=t.length-1,o=[];let r,l=2===i?"<svg>":"",c=lit_html_f;for(let i=0;i<s;i++){const s=t[i];let a,u,d=-1,y=0;for(;y<s.length&&(c.lastIndex=y,u=c.exec(s),null!==u);)y=c.lastIndex,c===lit_html_f?"!--"===u[1]?c=lit_html_v:void 0!==u[1]?c=lit_html_:void 0!==u[2]?($.test(u[2])&&(r=RegExp("</"+u[2],"g")),c=lit_html_m):void 0!==u[3]&&(c=lit_html_m):c===lit_html_m?">"===u[0]?(c=r??lit_html_f,d=-1):void 0===u[1]?d=-2:(d=c.lastIndex-u[2].length,a=u[1],c=void 0===u[3]?lit_html_m:'"'===u[3]?lit_html_g:lit_html_p):c===lit_html_g||c===lit_html_p?c=lit_html_m:c===lit_html_v||c===lit_html_?c=lit_html_f:(c=lit_html_m,r=void 0);const x=c===lit_html_m&&t[i+1].startsWith("/>")?" ":"";l+=c===lit_html_f?s+lit_html_n:d>=0?(o.push(a),s.slice(0,d)+lit_html_e+s.slice(d)+lit_html_h+x):s+lit_html_h+(-2===d?i:x)}return[lit_html_C(t,l+(t[s]||"<?>")+(2===i?"</svg>":"")),o]};class lit_html_V{constructor({strings:t,_$litType$:s},n){let r;this.parts=[];let c=0,a=0;const u=t.length-1,d=this.parts,[f,v]=lit_html_P(t,s);if(this.el=lit_html_V.createElement(f,n),lit_html_E.currentNode=this.el.content,2===s){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(r=lit_html_E.nextNode())&&d.length<u;){if(1===r.nodeType){if(r.hasAttributes())for(const t of r.getAttributeNames())if(t.endsWith(lit_html_e)){const i=v[a++],s=r.getAttribute(t).split(lit_html_h),e=/([.?@])?(.*)/.exec(i);d.push({type:1,index:c,name:e[2],strings:s,ctor:"."===e[1]?lit_html_k:"?"===e[1]?H:"@"===e[1]?lit_html_I:lit_html_R}),r.removeAttribute(t)}else t.startsWith(lit_html_h)&&(d.push({type:6,index:c}),r.removeAttribute(t));if($.test(r.tagName)){const t=r.textContent.split(lit_html_h),s=t.length-1;if(s>0){r.textContent=lit_html_i?lit_html_i.emptyScript:"";for(let i=0;i<s;i++)r.append(t[i],lit_html_l()),lit_html_E.nextNode(),d.push({type:2,index:++c});r.append(t[s],lit_html_l())}}}else if(8===r.nodeType)if(r.data===lit_html_o)d.push({type:2,index:c});else{let t=-1;for(;-1!==(t=r.data.indexOf(lit_html_h,t+1));)d.push({type:7,index:c}),t+=lit_html_h.length-1}c++}}static createElement(t,i){const s=lit_html_r.createElement("template");return s.innerHTML=t,s}}function lit_html_N(t,i,s=t,e){if(i===lit_html_w)return i;let h=void 0!==e?s._$Co?.[e]:s._$Cl;const o=lit_html_c(i)?void 0:i._$litDirective$;return h?.constructor!==o&&(h?._$AO?.(!1),void 0===o?h=void 0:(h=new o(t),h._$AT(t,s,e)),void 0!==e?(s._$Co??=[])[e]=h:s._$Cl=h),void 0!==h&&(i=lit_html_N(t,h._$AS(t,i.values),h,e)),i}class lit_html_S{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:s}=this._$AD,e=(t?.creationScope??lit_html_r).importNode(i,!0);lit_html_E.currentNode=e;let h=lit_html_E.nextNode(),o=0,n=0,l=s[0];for(;void 0!==l;){if(o===l.index){let i;2===l.type?i=new lit_html_M(h,h.nextSibling,this,t):1===l.type?i=new l.ctor(h,l.name,l.strings,this,t):6===l.type&&(i=new lit_html_L(h,this,t)),this._$AV.push(i),l=s[++n]}o!==l?.index&&(h=lit_html_E.nextNode(),o++)}return lit_html_E.currentNode=lit_html_r,e}p(t){let i=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++}}class lit_html_M{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,i,s,e){this.type=2,this._$AH=lit_html_T,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cv=e?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===t?.nodeType&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=lit_html_N(this,t,i),lit_html_c(t)?t===lit_html_T||null==t||""===t?(this._$AH!==lit_html_T&&this._$AR(),this._$AH=lit_html_T):t!==this._$AH&&t!==lit_html_w&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):lit_html_u(t)?this.k(t):this._(t)}S(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.S(t))}_(t){this._$AH!==lit_html_T&&lit_html_c(this._$AH)?this._$AA.nextSibling.data=t:this.T(lit_html_r.createTextNode(t)),this._$AH=t}$(t){const{values:i,_$litType$:s}=t,e="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=lit_html_V.createElement(lit_html_C(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===e)this._$AH.p(i);else{const t=new lit_html_S(e,this),s=t.u(this.options);t.p(i),this.T(s),this._$AH=t}}_$AC(t){let i=lit_html_A.get(t.strings);return void 0===i&&lit_html_A.set(t.strings,i=new lit_html_V(t)),i}k(t){lit_html_a(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const h of t)e===i.length?i.push(s=new lit_html_M(this.S(lit_html_l()),this.S(lit_html_l()),this,this.options)):s=i[e],s._$AI(h),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e)}_$AR(t=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class lit_html_R{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,s,e,h){this.type=1,this._$AH=lit_html_T,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=h,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=lit_html_T}_$AI(t,i=this,s,e){const h=this.strings;let o=!1;if(void 0===h)t=lit_html_N(this,t,i,0),o=!lit_html_c(t)||t!==this._$AH&&t!==lit_html_w,o&&(this._$AH=t);else{const e=t;let n,r;for(t=h[0],n=0;n<h.length-1;n++)r=lit_html_N(this,e[s+n],i,n),r===lit_html_w&&(r=this._$AH[n]),o||=!lit_html_c(r)||r!==this._$AH[n],r===lit_html_T?t=lit_html_T:t!==lit_html_T&&(t+=(r??"")+h[n+1]),this._$AH[n]=r}o&&!e&&this.j(t)}j(t){t===lit_html_T?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class lit_html_k extends lit_html_R{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===lit_html_T?void 0:t}}class H extends lit_html_R{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==lit_html_T)}}class lit_html_I extends lit_html_R{constructor(t,i,s,e,h){super(t,i,s,e,h),this.type=5}_$AI(t,i=this){if((t=lit_html_N(this,t,i,0)??lit_html_T)===lit_html_w)return;const s=this._$AH,e=t===lit_html_T&&s!==lit_html_T||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,h=t!==lit_html_T&&(s===lit_html_T||e);e&&this.element.removeEventListener(this.name,this,s),h&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class lit_html_L{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){lit_html_N(this,t)}}const lit_html_z={P:lit_html_e,A:lit_html_h,C:lit_html_o,M:1,L:lit_html_P,R:lit_html_S,D:lit_html_u,V:lit_html_N,I:lit_html_M,H:lit_html_R,N:H,U:lit_html_I,B:lit_html_k,F:lit_html_L},lit_html_Z=lit_html_t.litHtmlPolyfillSupport;lit_html_Z?.(lit_html_V,lit_html_M),(lit_html_t.litHtmlVersions??=[]).push("3.1.2");const lit_html_j=(t,i,s)=>{const e=s?.renderBefore??i;let h=e._$litPart$;if(void 0===h){const t=s?.renderBefore??null;e._$litPart$=h=new lit_html_M(i.insertBefore(lit_html_l(),t),t,void 0,s??{})}return h._$AI(t),h};
...
;// CONCATENATED MODULE: ./src/components/layout/layout.styles.ts


const styles = i `
  ${grid_t.styles}
  :host([variant='large-small']) .base {
    grid-template-columns: 1fr auto;
  }
  :host([variant='small-large']) .base {
...
/**
 * A utility component that applies column-based layout to immediate children with:
 * - with a pre-set layout as "variant"
 * - or set the rowColsxx attributes for custom media responsiveness.
 * @extends Grid
 * @attribute variant
 */
let Layout = class Layout extends grid_t {
    constructor() {
        super(...arguments);
...
__decorate([
    property_n({ attribute: 'variant' })
], Layout.prototype, "variant", void 0);
Layout = __decorate([
    defineCustomElement('cascade-layout')
], Layout);
