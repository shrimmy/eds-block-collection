...
/* harmony default export */ const hero_cta_styles = (i `
  ...
  @media (max-width: ${viewports.md - 0.02}px) {
    :host([mobile-order='heading-first']) .hero-cta {
  ...
  @media (min-width: ${viewports.md}px) {
    :host([align-image='left']) .hero-cta__layout {
      --hero-cta-layout-order: row-reverse;
    }
...
let HeroCta = class HeroCta extends lit_element_s {
    ...
    renderBlockHeading() {
        return x `<div class="hero-cta__block-heading">
      <slot name="block-heading"></slot>
    </div>`;
    }
    renderImage() {
        return x `<div class="hero-cta__layout-slot">
        ...
        <div class="hero-cta__container">
          <div class="hero-cta__row">
            <div class="hero-cta__col">
              <div class="hero-cta__layout">
                <div part="block-heading" class="hero-cta__layout-col">
                  ${blockHeading}
                </div>
                <div part="image" class="hero-cta__layout-col">${image}</div>
              </div>
            </div>
          </div>
        </div>
