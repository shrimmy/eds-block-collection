...
__webpack_require__.d(__webpack_exports__, {
  ImmersiveScroll: () => (/* binding */ ImmersiveScroll)
});
...
;// CONCATENATED MODULE: ./src/components/immersive-scroll/immersive-scroll.styles.ts

const cssPropDefaults = {
    backgroundColor: '#fff',
    color: '#000',
};
/* harmony default export */ const immersive_scroll_styles = (i `
  :host([theme-dark]) .is-layout {
  ...
  *,
  ...
  .asset-container {
    flex: 1;
    max-width: 100%;
    transform: translateX(-30%) translateY(0) scale(0.85);
    position: relative;
  }
  .asset-container-default {
    position: relative;
    flex: 1;
    max-width: 100%;
  }
  ...
  ::slotted(.is-details-header) {
    font-family: 'Segoe UI';
    font-weight: 600;
    font-size: 1.3rem;
    line-height: 1.625rem;
  }
  ::slotted(.is-details-content) {
    font-family: 'Segoe UI';
    font-weight: 400;
    font-size: 16px;
    line-height: 24px;
  }
  ::slotted(.largeDescriptiveText) {
    font-weight: bold;
  }
  .play-button-wrapper {
    position: absolute;
  ...
  .large-text2 {
    ...
    font-weight: 600;
    letter-spacing: 0em;
    background: linear-gradient(to right, #5440f1, #1f1068);
  ...
  .play-button {
    ...
    font-weight: 900;
    box-sizing: border-box;
    border: #5440f1 2px solid;
    border-radius: 50%;
    cursor: pointer;
    order: 2;
  }
  :host([theme-dark]) .play-button:focus {
    outline: 0.1875rem dotted #afadff;
  }
  :host([theme-dark]) .play-button {
    background-color: #33303d;
    color: #f2f2f2;
  }
  :host([theme-dark]) .large-text2 {
  ...
  .icon {
    filter: invert(8%) sepia(64%) saturate(7170%) hue-rotate(252deg)
      brightness(107%) contrast(91%);
  }
  :host([theme-dark]) .icon {
    filter: invert(66%) sepia(29%) saturate(768%) hue-rotate(202deg)
      brightness(101%) contrast(105%);
  }
  .card_icons-containner {
    display: contents;
  }
  ...
  @media (prefers-color-scheme: light) {
    .icon {
      filter: invert(45%) sepia(70%) saturate(2550%) hue-rotate(223deg)
        brightness(98%) contrast(95%);
    }
  }
  @media screen and (-ms-high-contrast: active) {
    .icon {
      filter: invert(100%) sepia(0%) saturate(7472%) hue-rotate(59deg)
...
;// CONCATENATED MODULE: ./src/components/immersive-scroll/index.ts
...
let ImmersiveScroll = class ImmersiveScroll extends WithLocalization {
    constructor() {
        super(...arguments);
        /**
         * Specifies if the main asset is video or not with a default value false
         *
         * @remarks
         * HTML Attribute: asset-is-video
         */
        ...
        /**
         * reflect dark theme if this attribute is present with default value false
         *
         * @remarks
         * HTML Attribute: theme-dark
         */
    ...
    /** Handle vertical scroll up/down */
    handleScroll() {
        if (this.noAnimation)
            return;
        const stagger = 0.1;
        ...
        mm.add('(prefers-reduced-motion: no-preference)', () => {
            ...
            this.assetContainer.classList.replace('asset-container', 'asset-container-default');
            ...
            tl.fromTo(this.largeTextCentered, { top: '50%', display: 'block', zoom: 'xl' }, { top: '-8', display: 'none' });
            tl.to(this.assetContainerDefault, { xPercent: 0, yPercent: 0, scale: 1, ease: 'elastic.out' }, '<');
            tl.to(this.largeText2, { opacity: 1, display: 'block' }, '<');
            tl.fromTo(this.assetContainerDefault, { xPercent: 0, yPercent: 0, scale: 1, ease: 'elastic.out' }, { xPercent: 0, yPercent: 4, scale: 0.85 });
            tl.to(this.largeText2, { opacity: 0, display: 'none' });
            if (!this.isMobile)
                tl.to(this.assetContainerDefault, { transformOrigin: 'left center', scale: 0.66 }, '<');
            else
                tl.to(this.assetContainer, { transformOrigin: 'center', scale: 0.9 }, '<');
            tl.from(this.details, { opacity: 0, stagger: stagger });
            tl.to(this.details, { opacity: 0, stagger: stagger }, stagger);
            tl.from(this.cardIcons, { opacity: 0, stagger: stagger });
            tl.to(this.cardIcons, { opacity: 0, stagger: stagger }, stagger);
            tl.from(this.rightDescription, { opacity: 0, stagger: stagger });
            tl.to(this.rightDescription, { opacity: 0, stagger: stagger }, stagger);
            return () => {
                this.noAnimation = true;
                this.assetContainerDefault.classList.replace('asset-container-default', 'asset-container');
            };
        });
    }
    firstUpdated() {
    ...
    setupAutoPauseListener() {
        this.autoPauseListener = () => {
            if (this.videoNode) {
                if (this.videoNode.currentTime >= 5) {
                    ...
                    this.videoNode.removeEventListener('timeupdate', this.autoPauseListener);
                }
            }
        };
        const setupTimeUpdateListener = () => {
            this.videoNode.addEventListener('timeupdate', this.autoPauseListener);
        };
        if (this.videoNode.readyState >= 1) {
            setupTimeUpdateListener();
        }
        else {
            this.videoNode.addEventListener('loadedmetadata', setupTimeUpdateListener);
        }
    }
    updatePlayButtonState() {
        if (this.videoNode && this.playButton) {
    ...
    renderPicture() {
      ...
      <div class="asset-container">
        <div
          class="font-cover ${this.themeDark ? 'font-cover-background' : ''}"
        ></div>
        <slot name="image"></slot>
        <div class="largeText_centered">
          <slot name="largeText1"></slot>
        </div>
    ...
    renderVideo() {
      ...
      <div class="asset-container">
        <div
          class="font-cover"
          ${this.themeDark ? 'font-cover-background' : ''}
        ></div>
        <slot
          name="video"
          @slotchange="${(e) => {
            ...
            this.videoNode = firstNode;
            if (this.noAnimation && this.playButton) {
                this.videoNode.autoplay = false;
                this.playButton.style.display = 'block';
            }
            this.setupAutoPauseListener();
        ...
        ${this.renderLargeText()}
        ${this.assetIsVideo ? this.renderPlayButton() : ''}
      </div>
    `;
    }
    renderPlayButton() {
        return x ` <div class="play-button-wrapper">
      <button
        id="play-pause-button"
        class="play-button"
        style=${this.noAnimation ? 'display: block;' : ''}
    ...
    renderDescription() {
      ...
      <div class="is-row">
        <div class="card_icons">
          <ul class="card_icons-containner">
            <li class="icon">
      ...
      <div class="is-row-common-txt">
        <slot name="small-title"></slot>
        <slot name="descriptive-text"></slot>
      </div>
    `;
    }
    renderContent() {
        return x `
      ${this.assetIsVideo ? this.renderVideo() : this.renderPicture()}
      <div class="is-row row-right--text">
        <div class="col-4 is-placeholder"></div>
        <div class="col-4 is-product-details">${this.renderDescription()}</div>
      </div>
    `;
    }
    render() {
        return x ` <div class="is-layout">
      <div
        class="header"
        style="
    display: ${this.noAnimation ? 'block;' : 'none;'}"
      >
        <slot name="header"></slot>
      </div>
      <div class="scroll-wrapper">${this.renderContent()}</div>
    </div>`;
    }
};
ImmersiveScroll.styles = [immersive_scroll_styles, colorUtils];
ImmersiveScroll.dict = {
    play: 'Play',
    pause: 'Pause',
};
__decorate([
    property_n({ attribute: 'asset-is-video', type: Boolean })
], ImmersiveScroll.prototype, "assetIsVideo", void 0);
__decorate([
    property_n({ attribute: 'no-animation', type: Boolean })
], ImmersiveScroll.prototype, "noAnimation", void 0);
__decorate([
    property_n({ attribute: 'theme-dark', type: Boolean, reflect: true })
], ImmersiveScroll.prototype, "themeDark", void 0);
__decorate([
    state_r()
], ImmersiveScroll.prototype, "isMobile", void 0);
__decorate([
    query_e('.play-button')
], ImmersiveScroll.prototype, "playButton", void 0);
__decorate([
    query_e('video')
], ImmersiveScroll.prototype, "video", void 0);
__decorate([
    query_e('.largeText_centered')
], ImmersiveScroll.prototype, "largeTextCentered", void 0);
__decorate([
    query_e('.large-text2')
], ImmersiveScroll.prototype, "largeText2", void 0);
__decorate([
    query_e('.asset-container-default')
], ImmersiveScroll.prototype, "assetContainerDefault", void 0);
__decorate([
    query_e('.asset-container')
], ImmersiveScroll.prototype, "assetContainer", void 0);
__decorate([
    query_e('.is-row-details')
], ImmersiveScroll.prototype, "details", void 0);
__decorate([
    query_e('.is-row-common-txt')
], ImmersiveScroll.prototype, "rightDescription", void 0);
__decorate([
    query_e('.card_icons')
], ImmersiveScroll.prototype, "cardIcons", void 0);
__decorate([
    query_e('.scroll-wrapper')
], ImmersiveScroll.prototype, "scrollWrapper", void 0);
ImmersiveScroll = __decorate([
    custom_element_t('cascade-immersive-scroll')
], ImmersiveScroll);
